				...
				<div class="row">
					<div class="col-lg-6">
						<div class="shadow-block task-block">
							<h4><span>Task Name</span> <button type="button" class="mark_complete-btn" data-toggle="modal" data-target="#addtask-popup">Mark As Complete</button></h4>
					...
					<div class="col-lg-6">
						<div class="shadow-block task-block">
							<h4>Task Name <button type="button" class="mark_complete-btn" data-toggle="modal" data-target="#reset_password-popup">Mark As Complete</button></h4>
							<h6>Assigned on: 03 May, 2020</h6>
							<h6 class="red_color">Due on: 20 May, 2020</h6>
							<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
						</div>
					...
					<div class="col-lg-6">
						<div class="shadow-block task-block">
							<h4>Task Name <button type="button" class="mark_complete-btn" data-toggle="modal" data-target="#raise_ticket-popup">Mark As Complete</button></h4>
							<h6>Assigned on: 03 May, 2020</h6>
							<h6 class="red_color">Due on: 20 May, 2020</h6>
							<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
						</div>
