  ...
  <body>
	...
	<div class="admin-portal-wrapper">
		<div class="admin-left-menu" id="mobile_adminnav">
			<a href="index.html" class="mobile-adminlogo"><img class="admin_logoimg" src="../assets/images/ic_logo_mobile.png" alt="" width="100%"></a>
			<ul>
				<li class="close_btn d-block d-xl-none" onclick="closeNav()"><img src="../assets/images/close.png" alt="" width="25"> </li>
				...
				<li><a href="#" data-toggle="modal" data-target="#logout-popup">
					<img class="default-icon ml-1" src="../assets/panel-img/logout.png" alt="" width="20"> 
					Logout</a>
				</li>
			</ul>
		</div>
